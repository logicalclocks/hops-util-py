...
def evolutionary_search(spark, objective_function, search_dict, direction = 'max', generations=10, popsize=10, mutation=0.5, crossover=0.7):
    """ Run the wrapper function with each hyperparameter combination as specified by the dictionary
    ...
    return differential_evolution.search(spark, objective_function, search_dict, direction=direction, generations=generations, popsize=popsize, mutation=mutation, crossover=crossover)
