...
def grid_search(spark_session, map_fun, args_dict=None):
    """ Run the wrapper function with each hyperparameter combination as specified by the dictionary
...
def evolutionary_search(spark, search_dict, objective_function, direction = 'max', maxiter=10, popsize=10, mutationfactor=0.5, crossover=0.7):
    """ Run the wrapper function with each hyperparameter combination as specified by the dictionary
    ...
    return differential_evolution.search(spark, search_dict, objective_function, direction=direction, maxiter=maxiter, popsize=popsize, mutationfactor=mutationfactor, crossover=crossover)
